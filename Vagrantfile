...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "vm2" do |n2|
      ...
      n2.vm.hostname = "vm2"
      n2.vm.network "public_network", bridge: $default_network_interface
      n2.vm.network "private_network", ip: $vm2_ip
      n2.vm.synced_folder ".", "/vagrant", disabled: true
      n2.vm.synced_folder "./config", "/configs"
      n2.vm.synced_folder "./keys", "/keys"
      n2.vm.provision "shell",
          inline: "apt-get update"
      n2.vm.provision 'shell', inline: "cat /keys/ansible-id_rsa.pub >> /home/vagrant/.ssh/authorized_keys"
    end
